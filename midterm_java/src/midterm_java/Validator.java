	...
	Scanner sc = new Scanner(System.in);
		...
		public static int getInt(Scanner sc, String prompt)
	    {
	        ...
	        while (isValid == false)
	        {
	            ...
	            if (sc.hasNextInt()) //hasnextint returns the value true or the token value if user input is integer
	            {
	                i = sc.nextInt(); // screen converts input into string
	                isValid = true;
	            }
	            else
	            {
	    ...
	    //getrequiredString method for input
